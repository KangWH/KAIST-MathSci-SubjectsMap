...
// 기초
const mas10001 = new Subject('MAS.10001', 기필, '미적분학 I', 'Calculus I', '3:0:3');
mainData.addSubject(mas10001);

const mas10002 = new Subject('MAS.10002', 기필, '미적분학 II', 'Calculus II', '3:0:3');
mas10002.addPrerequisite('MAS.10001');
mainData.addSubject(mas10002);

const mas10009 = new Subject('MAS.10009', 기선, '선형대수학개론', 'Introduction to Linear Algebra', '3:0:3');
mainData.addSubject(mas10009);

const mas10010 = new Subject('MAS.10010', 기선, '데이터과학을 위한 선형대수학', 'Linear Algebra for Data Science', '3:0:3');
mainData.addSubject(mas10010);

const mas20001 = new Subject('MAS.20001', 기선, '응용미분방정식', 'Differential Equations and Applications', '3:0:3');
mainData.addSubject(mas20001);

const mas20002 = new Subject('MAS.20002', 기선, '응용해석학', 'Applied Mathematical Analysis', '3:0:3');
mas20002.addPrerequisite('MAS.20001');
mas20002.setSemester(0, false);
mainData.addSubject(mas20002);

const mas20050 = new Subject('MAS.20050', 기선, '확률및통계', 'Probability and Statistics', '3:0:3');
mas20050.addPrerequisite('MAS.10002');
mainData.addSubject(mas20050);

// 2학년 전공선택
const mas20010 = new Subject('MAS.20010', 전선, '정수론 개론', 'Introduction to Number Theory', '3:0:3');
mas20010.setCategory(대수);
mas20010.setSemester(2, false);
mainData.addSubject(mas20010);

const mas20012 = new Subject('MAS.20012', 전선, '선형대수학', 'Linear Algebra', '3:0:3');
mas20012.setCategory(대수);
mas20012.addStyle('important');
mainData.addSubject(mas20012);

const mas20041 = new Subject('MAS.20041', 전선, '해석학 I', 'Analysis I', '3:2:4');
mas20041.setCategory(해석);
mas20041.addStyle('important');
mas20041.setSemester(2, false);
mainData.addSubject(mas20041);

const mas20042 = new Subject('MAS.20042', 전선, '해석학 II', 'Analysis II', '3:2:4');
mas20042.setCategory(해석);
mas20042.addPrerequisite('MAS.20041');
mas20042.setSemester(0, false);
mainData.addSubject(mas20042);

const mas20070 = new Subject('MAS.20070', 전선, '논리및집합', 'Logic and Set Theory', '3:0:3');
mas20070.setSemester(0, false);
mainData.addSubject(mas20070);

const mas20075 = new Subject('MAS.20075', 전선, '이산수학', 'Discrete Mathematics', '3:0:3');
mas20075.setCategory(이산);
mas20075.setSemester(2, false);
mainData.addSubject(mas20075);

// 3학년 전공선택
const mas30011 = new Subject('MAS.30011', 전선, '현대대수학 I', 'Modern Algebra I', '3:2:4');
mas30011.setCategory(대수);
mas30011.addStyle('important');
mas30011.setSemester(2, false);
mainData.addSubject(mas30011);

const mas30012 = new Subject('MAS.30012', 전선, '현대대수학 II', 'Modern Algebra II', '3:0:3');
...
const mas30021 = new Subject('MAS.30021', 전선, '미분기하학개론', 'Introduction to Differential Geometry', '3:2:4');
...
const mas30031 = new Subject('MAS.30031', 전선, '위상수학', 'Topology', '3:2:4');
mas30031.setCategory(기하위상);
mas30031.addStyle('important');
mas30031.setSemester(2, false);
mainData.addSubject(mas30031);

const mas30041 = new Subject('MAS.30041', 전선, '복소변수함수론', 'Complex Variables I', '3:0:3');
...
const mas30050 = new Subject('MAS.30050', 전선, '기초확률론', 'Elementary Probability Theory', '3:0:3');
mas30050.setCategory(확률통계);
mas30050.addPrerequisite('MAS.20050');
mas30050.setSemester(2, false);
mainData.addSubject(mas30050);

const mas30055 = new Subject('MAS.30055', 전선, '수리통계학', 'Mathematical Statistics', '3:0:3');
...
const mas30064 = new Subject('MAS.30064', 전선, '행렬계산과 응용', 'Matrix Computation and Application', '3:0:3');
...
const mas30074 = new Subject('MAS.30074', 전선, '최적화이론', 'Optimization Theory', '3:0:3');
...
// 4학년 전공선택
const mas40011 = new Subject('MAS.40011', 전선, '대수기하학개론', 'Introduction to Algebraic Geometry', '3:0:3');
...
const mas40012 = new Subject('MAS.40012', 전선, '가환대수학 입문', 'Introduction to Commutative Algebra', '3:0:3');
...
const mas40020 = new Subject('MAS.40020', 전선, '다양체해석학', 'Analysis on Manifolds', '3:0:3');
...
const mas40030 = new Subject('MAS.40030', 전선, '조합적 위상수학', 'Combinatorial Topology', '3:0:3');
...
const mas40041 = new Subject('MAS.40041', 전선, '르베그적분론', 'Lebesgue Integral Theory', '3:0:3');
mas40041.setCategory(해석);
mas40041.addPrerequisite('MAS.20041');
mas40041.setSemester(0, false);
mainData.addSubject(mas40041);

const mas40042 = new Subject('MAS.40042', 전선, '푸리에 해석과 응용', 'Fourier Analysis and Applications', '3:0:3');
...
const mas40055 = new Subject('MAS.40055', 전선, '선형모형', 'Linear Model', '3:0:3');
...
const mas40056 = new Subject('MAS.40056', 전선, '컴퓨터 통계방법론', 'Statistical Methods with Computer', '3:0:3');
...
const mas40067 = new Subject('MAS.40067', 전선, '수리생물학개론', 'Introduction to Mathematical Biology', '3:0:3');
...
const mas40073 = new Subject('MAS.40073', 전선, '수학과 인공지능개론', 'Introduction to Artificial Intelligence with Mathematics', '3:0:3');
...
const mas40077 = new Subject('MAS.40077', 전선, '그래프이론개론', 'Introduction to Graph Theory', '3:0:3');
...
// 2022년 이후 개설된 적 없음
// const mas40078 = new Subject('MAS.40078', 전선, '이산기하', 'Discrete Geometry', '3:0:3');
